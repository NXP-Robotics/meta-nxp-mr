...
# Change the wget user-agent to curl because crates.io seems to block wget agents (2026/5/12)
FETCHCMD_wget = "/usr/bin/env wget --tries=2 --timeout=100 --user-agent='curl/7.81.0'"
